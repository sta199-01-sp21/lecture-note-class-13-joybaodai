...
```{r data_manhattan}
manhattan <- read_csv("~/OneDrive - Duke University/STATS 199/RStudio Projects/lecture-note-class-13-joybaodai/manhattan.csv")
```
...
We are 95% confident that the true median price of 1-bedroom apartments in Manhattan is between 2162 and 2875.
...
- Parameter of interest: proportion of mice that died whilw not on treatment
- Sample: mice 
- Sample size:
...
We are 95% confident that the true proportion of mice that died while not on treatment is between 0.690 and 0.797. 
...
We are 90% confident that the true proportion of mice that lived while not on treatment is bewteen 0.552 and 0.651. 
